...
const Projects = () => {
  ...
  return (
    <section className="py-16 bg-gray-50 dark:bg-slate-900/60" id="projects">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {skillsData?.projects &&
            skillsData.projects.map((project: any) => (
              <div
                key={project.title}
                className={`bg-white shadow-lg rounded-2xl overflow-hidden text-left relative dark:bg-slate-800 dark:shadow-slate-950/40 ${project.type === "featured" ? "" : "hidden"
                  }`}
              >
                ...
                <div className="p-6">
                  ...
                  <p className="mb-4 text-gray-600 dark:text-slate-300">{project.description}</p>
                  ...
                  <div className="flex gap-4">
                    ...
                    <a
                      ...
                      className="flex items-center gap-2 rounded-lg border border-gray-300 px-4 py-2 text-sm transition hover:bg-gray-100 dark:border-slate-600 dark:text-slate-200 dark:hover:bg-slate-700"
                    >
                      Code
                    </a>
                  </div>
